...
export class CordovaExecutor extends CommandExecutor {
  ...
  public addPlatform(projectInfo:any, platformName:string): Promise<any>{
  ...
  public addPlatforms(projectInfo:any): Promise<any>{
    Logger.getInstance().info("Adding platforms for ", projectInfo);
    var cmd="cordova"
    var args = ["platform","add","--save"];
    var platformsStr = "";
    _.forEach(projectInfo.platforms,(platform:any) => {
  ...
  public addPlugin(projectInfo:any, pluginSpec:any, installOpt:any):Promise<any>{
  ...
  public removePlugin(projectInfo:any, pluginSpec:any):Promise<any>{
  ...
  public removePlatforms(platformList:any,projectRoot:string){
    Logger.getInstance().debug("removePlatforms called for ", platformList);
    _.forEach(platformList,(item:any,index:any)=>{
  ...
  public runBuild(projectRoot:string,platform:string,cliOptions:any){
    ...
    _.forEach(cliOptions.flags,(single:any) => {
  ...
  private patchExtraBrowserFile(projectRoot:string){
    ...
    let resDEDebuggerJS = ResourceManager.getResourcePath('injectedfiles/DEDebuggerClient.js');
    let resSocketIO = ResourceManager.getResourcePath('injectedfiles/socket.io.js');
  ...
  private applyGlobalCliOptions(cliOptions:any){
    if(cliOptions.envVariables){
      _.forEach(cliOptions.envVariables,(single:any) => {
  ...
  private getGlobalEnvCloneWithOptions(cliOptions:any){
