...
import { CordovaPlugin } from './CordovaCommons'
...
export class CordovaPluginsFinder {
  ...
  protected pluginsData:any = {};
     ...
     * Build the query
     */
    private buildQueryParamsString(names:Array<string>,keywords:Array<string>,platforms?:Array<string>):string{
      var ret = "";
      var i = 0;
     ...
     */
    public search(names:Array<string>,keywords:Array<string>,platforms?:Array<string>):Promise<Array<CordovaPlugin>>{
      return new Promise((resolve, reject) => {
        ...
        httpReq(queryUrl, function (error:any, response:any, body:any) {
            if (error){
